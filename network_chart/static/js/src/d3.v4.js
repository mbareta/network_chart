...
(function (global, factory) {
  ...
  typeof false && define === 'function' && define.amd ? define(['exports'], factory) :
...
var   tau$1 = 2 * pi$1;
  ...
  function defineD3(constructor, factory, prototype) {
  ...
  defineD3(Rgb, colorRgb, extend(Color, {
    brighter: function(k) {
  ...
  defineD3(Hsl, colorHsl, extend(Color, {
    brighter: function(k) {
      k = k == null ? brighter : Math.pow(brighter, k);
  ...
  defineD3(Hcl, colorHcl, extend(Color, {
    brighter: function(k) {
  ...
  defineD3(Cubehelix, cubehelix, extend(Color, {
    brighter: function(k) {
      k = k == null ? brighter : Math.pow(brighter, k);
